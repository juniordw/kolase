            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.hero_sections.update', $heroSection)}}" enctype="multipart/form-data"> 
                    ...
                    <div>
                        ...
                        <x-text-input id="heading" class="block mt-1 w-full" type="text" name="heading" value="{{$heroSection->heading}}" required autofocus autocomplete="heading" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_video" class="block mt-1 w-full" type="text" name="path_video" value="{{$heroSections->path_video}}" required autofocus autocomplete="path_video" />
