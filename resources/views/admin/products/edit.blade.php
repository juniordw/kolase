    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                @endforeach
                @endif
                <form method="POST" action="{{route('admin.products.update', $principle)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div>
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{Storage::url($product->tagline)}}" alt="" class="rounded-2xl object-cover w-[90px] h-[90px]">
