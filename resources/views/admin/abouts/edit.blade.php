            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                <form method="POST" action="{{route('admin.abouts.update', $about)}}" enctype="multipart/form-data"> 
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{$about->name}}" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        <div class="flex flex-col gap-y-5">
                            <x-input-label for="keypoints" :value="__('keypoints')" /> 
                                <input type="text" class="py-3 rounded-lg border-slate-300 border" value="{{$about->keypoint}}" name="keypoints[]">
                        </div>
